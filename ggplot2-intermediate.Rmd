...
* Labeling points
* SP's color section
* one more exercise in the Scales section
...
**Goal: understand what constitutes a ggplot _layer_, the relationship between _stats_ and _geoms_, and the difference between _scale transformations_ and _coordinate transformations_.**


# Assumptions

<span style="color: red;">**I assume you're familiar with the basic mechanics of ggplot2**</span> as covered in the introductory workshop:
...
Key point: different plot layers may, but don't have to, have different data sources and aesthetics.
...
Let's take a quick look at `mpg` before going farther.
...
The **tl;dr** of color theory is that color choices matter, and will create more impactful figures to communicate research more effectively. Colors opposite each other on the color star above are _complimentary_ and look good together. Why? Because [SCIENCE](https://www.smithsonianmag.com/smart-news/the-scientific-reason-complementary-colors-look-good-together-114030051/#:~:text=Complementary%20colors%20are%20especially%20pleasing,color%20spectrum%2C%20Apartment%20Therapy%20explains.&text=You'll%20see%20a%20faint%20orange%20afterimage%E2%80%94blue's%20opposite%20color.). Photoreceptor cells in your eyes like **balance**.
...
- `viridis` is a popuar color palette package that is colorblind-friendly
- `colorblindr` is a package that shows what your plot looks like in different color-vision-deficiency simulations
...
We can also use the `ggforce` package to label entire groups nicely:
