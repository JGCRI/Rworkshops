...
Finally, I tend not to use the explicit `stat_*` functionality of ggplot2 all that much; in general I find it simpler and clearer to pre-compute my summary statistics separate and then visualize them using the default geoms. YMMV however. 
