...
* Labeling points
* SP's color section
* First exercise -- maybe go back to economics example
* fix dotplot example
...
**Starting from `ggplot(mpg, aes(class, hwy, color = displ))`, write a custom summary function to produce the following graph:**
