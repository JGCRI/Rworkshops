...
```{r scale-labels, fig.show="hold", out.width="50%"}
theme_update(axis.text.y = element_text(size = 20, face = "bold"),
             title = element_text(size = 20, face = "bold"))
base <- ggplot(mpg, aes(cyl, year))
base + ggtitle("Default scale_y_continuous()")
base + scale_y_continuous(labels = scales::label_comma()) +
  ggtitle("label_comma")
base + scale_y_continuous(labels = scales::label_percent()) +
  ggtitle("label_percent")
base + scale_y_continuous(labels = scales::label_dollar()) +
  ggtitle("label_dollar")
theme_set(thm)
```
