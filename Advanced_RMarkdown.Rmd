...
There are lots of options that can be applied here, including size, whether the image floats, its justification, etc.
...
Let's say that again, because it's important: **always use relative paths**.

`render` has an `output_dir` parameter.
...
regime shifts [@Nolan2014-us]. Nolan et al. [-@Nolan2014-us] found that...
```
...
Thanks for attending this workshop on Advanced R Markdown documents! I hope it was useful.
