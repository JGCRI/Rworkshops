...
This is NOT intended to be a comprehensive survey of the possibilities with R Markdown.
...
Don't forget about the `cache=TRUE` option. Critical for keeping the build time of longer, complex documents under control.
...
I haven't used the `reactable` package but it can make impressive tables, and link those tables to data visualizations:
...
Thanks for attending this workshop on Advanced R Markdown documents! We hope it was useful.
